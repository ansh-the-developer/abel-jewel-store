    ...
    <Box as="section" id="contact" pt={20} bg="white" position="relative">
        ...
        <Flex direction={{ base: 'column', lg: 'row' }} gap={10} align="flex-start">
          ...
          >
            ...
            <Stack spacing={1} mb={8} color="gray.600" fontSize="sm">
              <Text fontWeight="600" color="abel.dark">Abel Jewelry</Text>
              <Text>33buldang-Gil, Cheonan-si</Text>
          ...
          <Box flex="1" w="full">
            ...
            >
              <Text fontSize="xs" fontWeight="bold" letterSpacing="widest" color="gray.400">
                MAP VIEW - CHEONAN-SI
              </Text>
            </Box>
      ...
      >
        ...
        <Box bg="abel.gold" w={8} h={8} borderRadius="full" display="flex" alignItems="center" justifyContent="center">
           {/* Simple White Dot Icon representing a notification/chat status */}
