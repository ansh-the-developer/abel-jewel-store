  ...
  return (
    <Box as="section" id="contact" pt={20} bg="white" position="relative">
        ...
        >
          ...
          >
            ...
            <Stack spacing={1} mb={8} color="gray.600" fontSize="sm">
              <Text fontWeight="600" color="abel.dark">
                Abel Jewelry (Rm 107)
              </Text>
            ...
            <Box borderTop="1px solid" borderColor="gray.100" pt={6}>
              ...
              <Stack spacing={0} color="gray.600" fontSize="sm">
                ...
                <Text>Close: 10:00 PM</Text>
                <Text mt={2} color="red.500" fontWeight="500">
                  {t("contact.closed_mon", "Closed on Mondays")}
                </Text>
                <Text color="green.600" fontWeight="500">
                  {t("contact.open_sun", "Opens on Sundays")}
                </Text>
              </Stack>
            </Box>
          </Box>
      ...
      >
        ...
        >
          © 2026 ABEL JEWELS. ALL RIGHTS RESERVED. MADE BY{" "}
          <Link
